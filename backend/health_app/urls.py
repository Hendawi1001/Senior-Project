...
from .views import (
    ...
    AdminDeleteUserView,
    AdminAlertsView,
    AdminPatientHealthView,
    AdminPatientChatView,
    dashboard_view,
...
urlpatterns = [
    ...
    path(
        ...
        PredictCardiacRiskView.as_view(),
        name='predict_cardiac_risk',
    ),

    # Hardware Sensor Data Endpoint
    path(
        'hardware/sensor/',
        HardwareSensorDataView.as_view(),
        name='hardware_sensor',
    ),

    # Admin / Doctor Dashboard APIs
    path(
        'admin/stats/',
    ...
    path(
        'admin/alerts/',
        AdminAlertsView.as_view(),
        name='admin_alerts',
    ),
    path(
        'admin/patients/<int:user_id>/health/',
        AdminPatientHealthView.as_view(),
        name='admin_patient_health',
    ),
    path(
        'admin/patients/<int:user_id>/chat/',
        AdminPatientChatView.as_view(),
        name='admin_patient_chat',
    ),
